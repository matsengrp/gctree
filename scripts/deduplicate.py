...
def main():
    parser = argparse.ArgumentParser(
        description="Convert a fasta file to philyp format. Headers must be a unique ID of less than "
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="use a special format convertion scheme e.g. for a Vitora lab GC fasta file. Options: [tas]",
    )
