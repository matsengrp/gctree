...
@click.option(
    ...
    is_flag=True,
    help=" non-leaf node labels, and associated sequences in the fasta file.",
)
def _cli_parsimony_score_from_files(
    treefiles, fasta_file, root_id, newick_format, include_internal_sequences
):
